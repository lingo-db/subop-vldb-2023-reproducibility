  ...
  func.func @main() {
    ...
    %12 = relalg.selection %11 (%arg0: !tuples.tuple){
     ...
     %nested = relalg.nested %5,%12 [@t::@id,@t::@title,@t1::@id,@t1::@title] -> [@t1::@title,@t1::@id,@ngramlist::@id] (%stream1, %stream2){
            ...
            %materialized = relalg.materialize %sel [@t1::@id,@t1::@title,@t2::@id, @t2::@title] => ["id","original","matching id","matching title"] : !subop.result_table<[id : i32,original: !db.string,matching_id: i32,matched_title:!db.string]>
